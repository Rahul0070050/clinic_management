...
import { checkMobileNumberHasAnyCharacter } from '../../../util/utilFunnctions';
...
function ForgotPassword() {
  ...
  async function submitHandler() {
    ...
    getRequest(`/doctor/check-mobile/+91${phone}`).then(async res => {
      console.log(res);
      return
      if (res.ok) {
  ...
  return (
    <div className='forgot-password-user'>
      {form == "phoneNumber" &&
        <form>
          <h1>skin care</h1>
          <p>enter your mobile number (Doctor)</p>
